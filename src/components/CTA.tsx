...
const CTA = () => {
  return (
    <section
      className='flex w-full flex-col items-center gap-10 bg-dark-navy py-[5.5rem] text-center tablet:py-[3.875rem] desktop:flex-row desktop:justify-between desktop:py-[6.375rem] desktop:px-[10.313rem] desktop:text-left'
      id='CTA'
    >
